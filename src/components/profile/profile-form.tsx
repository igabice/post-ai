...
export function ProfileForm() {
  const { user, updateProfile, availableTopics, availableFrequencies } =
    useApp();
      ...
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update your personal information and content preferences for the
              current team.
            </CardDescription>
          </CardHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Your signature to be appended to posts"
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
                    This signature can be automatically appended to your new
                    posts.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
                ...
                <FormItem>
                  <div className="mb-4">
                    <FormLabel className="text-base">
                      Core Topic Preferences
                    </FormLabel>
                    <FormDescription>
                      Select up to 3 topics that best represent your brand.
                    </FormDescription>
                  </div>
